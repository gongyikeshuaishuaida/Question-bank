...
Table recognition is disabled by default. Preserve table data by cropping the
complete source table as an image during question-note reconstruction.
...
def run_mineru(
    ...
    if flash:
        ...
        print(f"Extracting (high-precision, table recognition off): {pdf_path}")
...
def main() -> None:
    ...
    run_mineru(args.pdf, args.output, args.flash, args.formats, args.token)
