...
```powershell
py -X utf8 scripts/render_pdf_pages.py "试卷/202604-金华十校-高三-二模.pdf" --pages 1-7 --prefix jinhua --out-dir _pdf_pages
```
...
```powershell
py -X utf8 scripts/validate_question_bank.py --prefix 202604-金华十校-高三-二模
```
